...
_Source: Dungeon Master's Guide (2024), p. 173_

![The Lady of Pain appears without warning in the bustling streets of Sigil, and the city's residents get out of her way](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/084-06-001-the-lady-of-pain.webp#center)
...
![Outer Planes](Compendium/Mechanics/CLI/tables/outer-planes-xdmg.md)
...
![](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/085-06-002-the-multiverse.webp#center)
...
A number of spells allow direct or indirect access to different planes of existence. [Gate](Compendium/Mechanics/CLI/spells/gate-xphb.md) and [Plane Shift](Compendium/Mechanics/CLI/spells/plane-shift-xphb.md) can directly transport adventurers to any other plane, with different degrees of precision. [Etherealness](Compendium/Mechanics/CLI/spells/etherealness-xphb.md) allows adventurers to enter the Ethereal Plane. And [Astral Projection](Compendium/Mechanics/CLI/spells/astral-projection-xphb.md) lets adventurers project themselves into the Astral Plane and from there travel to the Outer Planes.
...
![A portal to the Beastlands opens amid the branches of the World Tree](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/086-06-003-portal-to-the-beastlands.webp#center)
...
![Planar Adventure Situations](Compendium/Mechanics/CLI/tables/planar-adventure-situations-xdmg.md)
...
![Layers of the Abyss](Compendium/Mechanics/CLI/tables/layers-of-the-abyss-xdmg.md)
...
![The detritus of the Planes is tangled in the Demonweb Pits](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/087-06-004-demonweb-pits.webp#center)
...
![Layers of Acheron](Compendium/Mechanics/CLI/tables/layers-of-acheron-xdmg.md)
...
![Layers of Arborea](Compendium/Mechanics/CLI/tables/layers-of-arborea-xdmg.md)
...
![](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/088-06-005-arcadia.webp#center)
...
![Layers of Arcadia](Compendium/Mechanics/CLI/tables/layers-of-arcadia-xdmg.md)
...
![Astral Color Pools](Compendium/Mechanics/CLI/tables/astral-color-pools-xdmg.md)
...
![Psychic Wind Location Effects](Compendium/Mechanics/CLI/tables/psychic-wind-location-effects-xdmg.md)
...
![Psychic Wind Psychic Effects](Compendium/Mechanics/CLI/tables/psychic-wind-psychic-effects-xdmg.md)
...
![Layers of Bytopia](Compendium/Mechanics/CLI/tables/layers-of-bytopia-xdmg.md)
...
![Layers of Carceri](Compendium/Mechanics/CLI/tables/layers-of-carceri-xdmg.md)

#### Prison Plane

![Unknown horrors are entrapped in the ice of Carceri](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/090-06-007-ice-of-carceri.webp#center)

No one can leave Carceri easily. Magical efforts to leave the plane by any spell other than [Wish](Compendium/Mechanics/CLI/spells/wish-xphb.md) simply fail. Portals and gates that open onto the plane become one-way only. Secret passages out of the plane exist, but they are hidden and well guarded by traps and deadly monsters. And though the River Styx flows between Carceri and its neighbors, the passage is extremely dangerous, and ferries leading out of Carceri are both rare and expensive.
...
![Aarakocra scouts return home to a city on the Plane of Air](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/091-06-008-plane-of-air.webp#center)
...
Built atop a tall basalt crag in the middle of a lava river is an iron-walled tavern that is most easily reached by hot-air balloon. The proprietor is a sentient [Flame Tongue (Mace)](Compendium/Mechanics/CLI/items/flame-tongue-xdmg.md) named Torchy, who sells a fine ale and seems to have a new wielder every few months. Torchy's is a popular hangout for ballooning enthusiasts.
...
![The City of Brass is a hub for trade from across the multiverse](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/092-06-009-city-of-brass.webp#center)
...
![Layers of Elysium](Compendium/Mechanics/CLI/tables/layers-of-elysium-xdmg.md)
...
Belierin is said to be the prison of some deadly creature. Some tales say it's a powerful titan, perhaps the [tarrasque](Compendium/Mechanics/CLI/bestiary/monstrosity/tarrasque-xmm.md), while others claim it's a deposed duke of the Nine Hells, a banished elemental prince, or even a near-dead deity. Evil creatures sometimes lurk in the marshes, seeking to free the prisoner or claim some power from it.
...
Characters can use the [Etherealness](Compendium/Mechanics/CLI/spells/etherealness-xphb.md) spell to enter the Border Ethereal. The [Plane Shift](Compendium/Mechanics/CLI/spells/plane-shift-xphb.md) spell allows transport to the Border Ethereal or the Deep Ethereal, but unless the intended destination is a specific location or a teleportation circle, the point of arrival could be anywhere on the plane.
...
To reach the Deep Ethereal, one typically needs a [Plane Shift](Compendium/Mechanics/CLI/spells/plane-shift-xphb.md) spell, a [Gate](Compendium/Mechanics/CLI/spells/gate-xphb.md) spell, or a magical portal. Visitors to the Deep Ethereal are engulfed by roiling mist. Scattered throughout the plane are curtains of vaporous color, and passing through a curtain leads a traveler to a region of the Border Ethereal connected to a specific Inner Plane, the Material Plane, the Feywild, or the Shadowfell. The color of the curtain indicates the plane whose Border Ethereal the curtain conceals; see the Ethereal Curtains table. The curtains are also distinguishable by texture and temperature, each one reflecting something of the nature of the plane beyond.

![The Radiant Citadel is a refuge in the Ethereal Plane, despite its proximity to a raging ether cyclone](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/093-06-010-the-radiant-citadel.webp#center)

![Deep Ethereal; Ethereal Curtains](Compendium/Mechanics/CLI/tables/deep-ethereal-ethereal-curtains-xdmg.md)
...
An ether cyclone is a serpentine column that spins through the plane. The cyclone appears abruptly, distorting and uprooting everything in its path and carrying the debris for miles. Travelers with a [Passive Perception](Compendium/Mechanics/CLI/Rules/variant-rules/passive-perception-xphb.md) score of 15 or higher receive 1 minute of warning: a deep thrum in the ethereal matter. Travelers who can't reach a curtain or portal leading elsewhere suffer the cyclone's effect. Roll `1d20` and consult the Ether Cyclone table to determine the effect on all creatures in the vicinity.

![Ether Cyclones; Ether Cyclone](Compendium/Mechanics/CLI/tables/ether-cyclones-ether-cyclone-xdmg.md)

#### Radiant Citadel

![](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/094-06-011-lotus.webp#center)
...
![When the Dragon's Tear comet appears above Firestorm Peak, the Vast Gate forms a bridge to the Far Realm](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/095-06-012-the-vast-gate.webp#center)
...
Whenever a creature or group of creatures leaves the Feywild after spending at least 1 day on that plane, you can choose a time change that works best for your campaign, if any, or roll on the Feywild Time Warp table. A [Wish](Compendium/Mechanics/CLI/spells/wish-xphb.md) spell can be used to remove the effect on up to ten creatures. Some powerful Fey have the ability to grant such wishes and might do so if the beneficiaries agree to subject themselves to a [Geas](Compendium/Mechanics/CLI/spells/geas-xphb.md) spell and complete a quest after the _Wish_ spell is cast.

![Feywild Time Warp](Compendium/Mechanics/CLI/tables/feywild-time-warp-xdmg.md)
...
![Fey revel in the Gloaming Court under the watchful eye of the Queen of Air and Darkness](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/096-06-013-the-gloaming-court.webp#center)
...
![Layers of Gehenna](Compendium/Mechanics/CLI/tables/layers-of-gehenna-xdmg.md)
...
![Layers of Hades](Compendium/Mechanics/CLI/tables/layers-of-hades-xdmg.md)

#### Plane of Gloom

At the end of each Long Rest taken on the plane, a visitor makes a DC 10 Wisdom saving throw. On a failed save, the creature gains 1 [Exhaustion](Compendium/Mechanics/CLI/Rules/conditions.md#Exhaustion) level that can't be removed while the creature is in Hades. If the creature reaches 6 Exhaustion levels, it doesn't die. Instead, it permanently transforms into a [Larva](Compendium/Mechanics/CLI/bestiary/fiend/larva-xmm.md), whereupon all Exhaustion levels afflicting the creature are removed.
...
![With its magical marvels of technology, Eberron is one of countless worlds on the Material Plane](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/097-06-014-eberron-technology.webp#center)
...
The most direct method involves the use of spells such as [Teleportation Circle](Compendium/Mechanics/CLI/spells/teleportation-circle-xphb.md) or [Teleport](Compendium/Mechanics/CLI/spells/teleport-xphb.md), or magical portals like those described in this chapter. This magic causes the user to appear in a known teleportation circle or some other location in another world.
...
![The Seven Heavens of Mount Celestia beckon virtuous souls toward ever-greater heights](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/098-06-015-mount-celestia.webp#center)

![Layers of Mount Celestia](Compendium/Mechanics/CLI/tables/layers-of-mount-celestia-xdmg.md)
...
In some locations on the Negative Plane, the intensity of the plane is so great that the negative energy folds in on itself, stabilizing into solid chunks of matter that devour light. These chunks, called voidstones, are thought to be the source of [Spheres of Annihilation](Compendium/Mechanics/CLI/items/sphere-of-annihilation-xdmg.md) and similar magical effects. Anything that comes into contact with a voidstone is destroyed in seconds.
...
![Layers of the Nine Hells](Compendium/Mechanics/CLI/tables/layers-of-the-nine-hells-xdmg.md)

#### Avernus

![The first of Nine Hells, Avernus, is an eternal battlefield in the Blood War](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/099-06-016-avernus.webp#center)
...
![Asmodeus, the Lord of the Nine, maintains a veneer of pleasantry while inflicting agony on imprisoned souls](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/100-06-017-asmodeus.webp#center)
...
![Gate-Towns of the Outlands](Compendium/Mechanics/CLI/tables/gate-towns-of-the-outlands-xdmg.md)
...
![Layers of Pandemonium](Compendium/Mechanics/CLI/tables/layers-of-pandemonium-xdmg.md)
...
![Three adventurers brave the howling winds of Pandemonium in search of Howler's Crag](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/101-06-018-winds-of-pandemonium.webp#center)
...
![The Shadowfell is a realm of death, despair, and dread](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/102-06-019-the-shadowfell.webp#center)
...
![Shadowfell Despair](Compendium/Mechanics/CLI/tables/shadowfell-despair-xdmg.md)
...
![In the cosmopolitan streets of Sigil, creatures from across the multiverse coexist in uneasy peace](Compendium/Mechanics/CLI/books/dungeon-masters-guide-2024/img/103-06-020-citizens-of-sigil.webp#center)
...
![Layers of Ysgard](Compendium/Mechanics/CLI/tables/layers-of-ysgard-xdmg.md)
