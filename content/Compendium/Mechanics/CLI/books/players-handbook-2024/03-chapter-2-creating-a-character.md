...
![World-traveling explorers Hank, Bobby, Sheila, Diana, and Presto stand on the threshold of their next adventure](Compendium/Mechanics/CLI/books/players-handbook-2024/img/012-02-001-world-traveling-explorers.webp#center)
...
![Choose a Class; Class Overview](Compendium/Mechanics/CLI/tables/choose-a-class-class-overview-xphb.md)

> [!note] A Balanced Party
>
> The classic D\&D party comprises a [Cleric](Compendium/Mechanics/CLI/classes/cleric-xphb.md), [Fighter](Compendium/Mechanics/CLI/classes/fighter-xphb.md), [Rogue](Compendium/Mechanics/CLI/classes/rogue-xphb.md), and [Wizard](Compendium/Mechanics/CLI/classes/wizard-xphb.md). Those four classes have the longest history in the game, but more importantly, they bring a balanced mix of capabilities to adventures. You're welcome to use that party setup or modify it using these guidelines:
>
> - **Cleric.** Replace with [Bard](Compendium/Mechanics/CLI/classes/bard-xphb.md) or [Druid](Compendium/Mechanics/CLI/classes/druid-xphb.md)
> - **Fighter.** Replace with [Barbarian](Compendium/Mechanics/CLI/classes/barbarian-xphb.md), [Monk](Compendium/Mechanics/CLI/classes/monk-xphb.md), [Paladin](Compendium/Mechanics/CLI/classes/paladin-xphb.md), or [Ranger](Compendium/Mechanics/CLI/classes/ranger-xphb.md)
> - **Rogue.** Replace with [Bard](Compendium/Mechanics/CLI/classes/bard-xphb.md) or [Ranger](Compendium/Mechanics/CLI/classes/ranger-xphb.md)
> - **Wizard.** Replace with [Bard](Compendium/Mechanics/CLI/classes/bard-xphb.md), [Sorcerer](Compendium/Mechanics/CLI/classes/sorcerer-xphb.md), or [Warlock](Compendium/Mechanics/CLI/classes/warlock-xphb.md)\
>   ^a-balanced-party

#### Write Your Level

Write your character's level on your character sheet. Typically, a character starts at level 1 and advances in level by adventuring and gaining [Experience Points](Compendium/Mechanics/CLI/Rules/variant-rules/experience-points-xphb.md) (XP).
...
![Choose a Background; Ability Scores and Backgrounds](Compendium/Mechanics/CLI/tables/choose-a-background-ability-scores-and-backgrounds-xphb.md)
...
Your background and class both provide starting equipment. Any coins that you gain at this step can be immediately spent on equipment from "chapter 6". In addition, you can have one [trinket](Compendium/Mechanics/CLI/items/trinket-xphb.md) at no cost at the end of this chapter.
...
![Consider how your choices combine to set your character on the path to adventure](Compendium/Mechanics/CLI/books/players-handbook-2024/img/013-02-002-character-choices.webp#center)

#### Choose a Species

Choose a species for your character. The following species options are detailed in "chapter 4": [Aasimar](Compendium/Mechanics/CLI/races/aasimar-xphb.md), [Dragonborn](Compendium/Mechanics/CLI/races/dragonborn-xphb.md), [Dwarf](Compendium/Mechanics/CLI/races/dwarf-xphb.md), [Elf](Compendium/Mechanics/CLI/races/elf-xphb.md), [Gnome](Compendium/Mechanics/CLI/races/gnome-xphb.md), [Goliath](Compendium/Mechanics/CLI/races/goliath-xphb.md), [Halfling](Compendium/Mechanics/CLI/races/halfling-xphb.md), [Human](Compendium/Mechanics/CLI/races/human-xphb.md), [Orc](Compendium/Mechanics/CLI/races/orc-xphb.md), and [Tiefling](Compendium/Mechanics/CLI/races/tiefling-xphb.md). Once you've chosen a species, write it on your character sheet. Then record your species' traits.

Your character's [size](Compendium/Mechanics/CLI/Rules/variant-rules/size-xphb.md) and [Speed](Compendium/Mechanics/CLI/Rules/variant-rules/speed-xphb.md) are determined by the character's species; record these in the appropriate places on your character sheet as well (you may write just the first letter of your size).
...
![Choose Languages; Standard Languages](Compendium/Mechanics/CLI/tables/choose-languages-standard-languages-xphb.md)
...
![Choose Languages; Rare Languages](Compendium/Mechanics/CLI/tables/choose-languages-rare-languages-xphb.md)
...
![Ability Score Point Costs](Compendium/Mechanics/CLI/tables/ability-score-point-costs-xphb.md)
...
![Assign Ability Scores; Standard Array by Class](Compendium/Mechanics/CLI/tables/assign-ability-scores-standard-array-by-class-xphb.md)
...
![Determine Ability Modifiers; Ability Scores and Modifiers](Compendium/Mechanics/CLI/tables/determine-ability-modifiers-ability-scores-and-modifiers-xphb.md)
...
![](Compendium/Mechanics/CLI/books/players-handbook-2024/img/014-02-003-strength-icon.webp#center)

![Describe Appearance and Personality; Strength](Compendium/Mechanics/CLI/tables/describe-appearance-and-personality-strength-xphb.md)

![](Compendium/Mechanics/CLI/books/players-handbook-2024/img/015-02-004-dexterity-icon.webp#center)

![Describe Appearance and Personality; Dexterity](Compendium/Mechanics/CLI/tables/describe-appearance-and-personality-dexterity-xphb.md)

![](Compendium/Mechanics/CLI/books/players-handbook-2024/img/016-02-005-constitution-icon.webp#center)

![Describe Appearance and Personality; Constitution](Compendium/Mechanics/CLI/tables/describe-appearance-and-personality-constitution-xphb.md)

![](Compendium/Mechanics/CLI/books/players-handbook-2024/img/017-02-006-intelligence-icon.webp#center)

![Describe Appearance and Personality; Intelligence](Compendium/Mechanics/CLI/tables/describe-appearance-and-personality-intelligence-xphb.md)

![](Compendium/Mechanics/CLI/books/players-handbook-2024/img/018-02-007-wisdom-icon.webp#center)

![Describe Appearance and Personality; Wisdom](Compendium/Mechanics/CLI/tables/describe-appearance-and-personality-wisdom-xphb.md)

![](Compendium/Mechanics/CLI/books/players-handbook-2024/img/019-02-008-charisma-icon.webp#center)

![Describe Appearance and Personality; Charisma](Compendium/Mechanics/CLI/tables/describe-appearance-and-personality-charisma-xphb.md)
...
![Alignments might be visualized as a grid like this—along with creatures that embody those alignments](Compendium/Mechanics/CLI/books/players-handbook-2024/img/020-02-009-alignments.webp#center)
...
>
> Most creatures that lack the capacity for rational thought don't have alignments; they are unaligned. [Sharks](Compendium/Mechanics/CLI/bestiary/beast/reef-shark-xmm.md) are savage predators, for example, but they aren't evil; they are unaligned.
> ^unaligned-creatures
...
![Alignment and Personality; Personality Traits by Alignment](Compendium/Mechanics/CLI/tables/alignment-and-personality-personality-traits-by-alignment-xphb.md)
...
Sometimes your DM will determine whether your character notices something without asking you to make a Wisdom ([Perception](Compendium/Mechanics/CLI/Rules/skills.md#Perception)) check; the DM uses your Passive Perception instead. Passive Perception is a score that reflects a general awareness of your surroundings when you're not actively looking for something. Use this formula to determine your Passive Perception score:

<span class='abilityGeneric'>**Passive Perception.**</span>

Include all modifiers that apply to your Wisdom ([Perception](Compendium/Mechanics/CLI/Rules/skills.md#Perception)) checks. For example, if your character has a Wisdom of 15 and proficiency in the [Perception](Compendium/Mechanics/CLI/Rules/skills.md#Perception) skill, you have a Passive Perception of 14 (10 + 2 for your Wisdom modifier + 2 for proficiency).
...
![Level 1 Hit Points by Class](Compendium/Mechanics/CLI/tables/level-1-hit-points-by-class-xphb.md)

The character sheet includes room to note your current Hit Points when you take damage, as well as any [Temporary Hit Points](Compendium/Mechanics/CLI/Rules/variant-rules/temporary-hit-points-xphb.md) you might gain. There's also space to track [Death Saving Throws](Compendium/Mechanics/CLI/Rules/variant-rules/death-saving-throw-xphb.md).
...
Without armor or a shield, your base [Armor Class](Compendium/Mechanics/CLI/Rules/variant-rules/armor-class-xphb.md) is 10 plus your Dexterity modifier. If your starting equipment includes armor or a Shield (or both), calculate your AC using the rules in "chapter 6". A class feature might give you a different way to calculate your AC.
...
![Adventuring equipment improves as a character progresses through the tiers of play](Compendium/Mechanics/CLI/books/players-handbook-2024/img/021-02-010-adventuring-equipment.webp#center)

While going on adventures, your character gains experience, represented by [Experience Points](Compendium/Mechanics/CLI/Rules/variant-rules/experience-points-xphb.md) (XP). A character who reaches a specified Experience Point total advances in capability. This advancement is called gaining a level.
...
![Level Advancement; Character Advancement](Compendium/Mechanics/CLI/tables/level-advancement-character-advancement-xphb.md)
...
- **Adjust Hit Points and Hit Point Dice.** Each time you gain a level, you gain an additional Hit Die. Roll that die, add your Constitution modifier to the roll, and add the total (minimum of 1) to your Hit Point maximum. Instead of rolling, you can use the fixed value shown in the Fixed Hit Points by Class table.
  ...
  ![Adjust Hit Points and Hit Point Dice; Fixed Hit Points by Class](Compendium/Mechanics/CLI/tables/adjust-hit-points-and-hit-point-dice-fixed-hit-points-by-class-xphb.md)
...
In tier 2, characters are full-fledged adventurers. Spellcasters gain iconic spells such as [Fireball](Compendium/Mechanics/CLI/spells/fireball-xphb.md), [Lightning Bolt](Compendium/Mechanics/CLI/spells/lightning-bolt-xphb.md), and [Raise Dead](Compendium/Mechanics/CLI/spells/raise-dead-xphb.md). Most weapon-focused classes gain the ability to make multiple attacks in a round. The characters now face dangers that threaten cities and kingdoms.
...
![Starting Equipment at Higher Levels](Compendium/Mechanics/CLI/tables/starting-equipment-at-higher-levels-xphb.md)
...
![Spellcasting; Multiclass Spellcaster: Spell Slots per Spell Level](Compendium/Mechanics/CLI/tables/spellcasting-multiclass-spellcaster-spell-slots-per-spell-level-xphb.md)
...
This table might give you spell slots of a higher level than the spells you prepare. You can use those slots but only to cast your lower-level spells. If a lower-level spell that you cast, like [Burning Hands](Compendium/Mechanics/CLI/spells/burning-hands-xphb.md), has an enhanced effect when cast at a higher level, you can use the enhanced effect as normal.
...
![A character with Paladin and Warlock levels might call on both a mighty oath and an otherworldly patron](Compendium/Mechanics/CLI/books/players-handbook-2024/img/022-02-011-paladin-warlock-multiclass.webp#center)

## Trinkets

When you make your character, you can roll once on the [Trinkets](Compendium/Mechanics/CLI/items/trinket-xphb.md) table to gain a Tiny trinket, a simple item lightly touched by mystery. The DM might also use this table. It can help stock a room in a dungeon or fill a creature's pockets.
