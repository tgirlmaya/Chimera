...
| Shipbuilders' Guild | Crossed oars | You assign shipbuilders to build one of the vehicles in the [Airborne and Waterborne Vehicles](Compendium/Mechanics/CLI/tables/large-vehicles-airborne-and-waterborne-vehicles-xphb.md) table of the "Player's Handbook". You pay the full cost of the vehicle, and the work takes 1 day per 1,000 GP of the vehicle's cost (a [Rowboat](Compendium/Mechanics/CLI/items/rowboat-xphb.md) can be made in 1 day). |
...
_Source: Dungeon Master's Guide (2024) p. 341_
