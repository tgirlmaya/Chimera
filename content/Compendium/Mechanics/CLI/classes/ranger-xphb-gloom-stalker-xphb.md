...
**Ambusher's Leap.** At the start of your first turn of each combat, your [Speed](Compendium/Mechanics/CLI/Rules/variant-rules/speed-xphb.md) increases by 10 feet until the end of that turn.
...
**Initiative Bonus.** When you roll [Initiative](Compendium/Mechanics/CLI/Rules/variant-rules/initiative-xphb.md), you can add your Wisdom modifier to the roll.
...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [Disguise Self](Compendium/Mechanics/CLI/spells/disguise-self-xphb.md) |
| 5th | [Rope Trick](Compendium/Mechanics/CLI/spells/rope-trick-xphb.md) |
| 9th | [Fear](Compendium/Mechanics/CLI/spells/fear-xphb.md) |
| 13th | [Greater Invisibility](Compendium/Mechanics/CLI/spells/greater-invisibility-xphb.md) |
| 17th | [Seeming](Compendium/Mechanics/CLI/spells/seeming-xphb.md) |
^gloom-stalker-spells

### Umbral Sight (Level 3)

You gain [Darkvision](Compendium/Mechanics/CLI/Rules/senses.md#Darkvision) with a range of 60 feet. If you already have [Darkvision](Compendium/Mechanics/CLI/Rules/senses.md#Darkvision) when you gain this feature, its range increases by 60 feet.

You are also adept at evading creatures that rely on [Darkvision](Compendium/Mechanics/CLI/Rules/senses.md#Darkvision). While entirely in [Darkness](Compendium/Mechanics/CLI/Rules/variant-rules/darkness-xphb.md), you have the [Invisible](Compendium/Mechanics/CLI/Rules/conditions.md#Invisible) condition to any creature that relies on [Darkvision](Compendium/Mechanics/CLI/Rules/senses.md#Darkvision) to see you in that [Darkness](Compendium/Mechanics/CLI/Rules/variant-rules/darkness-xphb.md).
...
**Mass Fear.** The target and each creature within 10 feet of it must make a Wisdom saving throw against your spell save DC. On a failed save, a creature has the [Frightened](Compendium/Mechanics/CLI/Rules/conditions.md#Frightened) condition until the start of your next turn.

### Shadowy Dodge (Level 15)

When a creature makes an attack roll against you, you can take a [Reaction](Compendium/Mechanics/CLI/Rules/variant-rules/reaction-xphb.md) to impose [Disadvantage](Compendium/Mechanics/CLI/Rules/variant-rules/disadvantage-xphb.md) on that roll. Whether the attack hits or misses, you can then teleport up to 30 feet to an unoccupied space you can see.
