...
created: 2026-08-28T20:41:12.787Z
modified: 2026-08-29T18:07:49.019Z
tags:
...
_Weapon ([greatclub](Compendium/Mechanics/CLI/items/greatclub-xphb.md)), very rare (requires attunement)_\
![](Compendium/Mechanics/CLI/items/img/thunderous-greatclub.webp#right)
...
As a [Magic](Compendium/Mechanics/CLI/Rules/actions.md#Magic) action, you can strike the weapon against a hard surface to create a loud clap of thunder audible out to 300 feet. You also create a 30-foot [Cone](Compendium/Mechanics/CLI/Rules/variant-rules/cone-area-of-effect-xphb.md) of thunderous energy. Each creature in the [Cone](Compendium/Mechanics/CLI/Rules/variant-rules/cone-area-of-effect-xphb.md) must succeed on a DC 15 Strength saving throw or have the [Prone](Compendium/Mechanics/CLI/Rules/conditions.md#Prone) condition. Nonmagical objects in the [Cone](Compendium/Mechanics/CLI/Rules/variant-rules/cone-area-of-effect-xphb.md) that aren't being worn or carried take `3d8` Thunder damage.

## Earthquake

As a [Magic](Compendium/Mechanics/CLI/Rules/actions.md#Magic) action, you can strike the weapon against the ground to create an intense seismic disturbance in a 50-foot-radius circle centered on the point of impact. Structures in contact with the ground in that area take 50 Bludgeoning damage, and each creature on the ground in that area must succeed on a DC 20 Dexterity saving throw or have the [Prone](Compendium/Mechanics/CLI/Rules/conditions.md#Prone) condition. If that creature is also [Concentrating](Compendium/Mechanics/CLI/Rules/conditions.md#Concentration), it must succeed on a DC 20 Constitution saving throw or its [Concentration](Compendium/Mechanics/CLI/Rules/conditions.md#Concentration) is broken. In addition, you can cause a 30-foot-deep, 10-foot-wide fissure to open up on the ground anywhere in the area. Any creature on a spot where the fissure opens must make a DC 20 Dexterity saving throw, falling into the fissure on a failed save or moving with the fissure's edge on a successful one. Any structure on a spot where the fissure opens collapses into the fissure. Once you use this property, it can't be used again until the next dawn.

_Source: Dungeon Master's Guide (2024) p. 316. Available in the <span title='Systems Reference Document (5.2)'>SRD</span> and the Free Rules (2024)_
