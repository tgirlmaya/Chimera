...
_Source: Dungeon Master's Guide (2024) p. 86_
...
| 4 | The NPC is under a magical compulsion (perhaps a [Geas](Compendium/Mechanics/CLI/spells/geas-xphb.md) spell or some kind of curse) to behave in a certain way. |
