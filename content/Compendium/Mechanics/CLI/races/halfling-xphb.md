...
aliases:
  - Halfling
created: 2026-08-28T20:41:13.976Z
modified: 2026-08-29T18:07:46.453Z
tags:
...
_Source: Player's Handbook (2024) p. 193. Available in the <span title='Systems Reference Document (5.2)'>SRD</span> and the Free Rules (2024)_\
![](Compendium/Mechanics/CLI/races/img/halfling.webp#right)
...
You have [Advantage](Compendium/Mechanics/CLI/Rules/variant-rules/advantage-xphb.md) on saving throws you make to avoid or end the [Frightened](Compendium/Mechanics/CLI/Rules/conditions.md#Frightened) condition.
...
When you roll a 1 on the `d20` of a [D20 Test](Compendium/Mechanics/CLI/Rules/variant-rules/d20-test-xphb.md), you can reroll the die, and you must use the new roll.

### Naturally Stealthy

You can take the [Hide](Compendium/Mechanics/CLI/Rules/actions.md#Hide) action even when you are obscured only by a creature that is at least one size larger than you.
